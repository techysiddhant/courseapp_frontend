  ...
  return (
    <section className="home">
        ...
        >
          ...
          >
            ...
            <Heading
              ...
              size={'2xl'}
            >
              Different Way to Shape Your Future
            </Heading>
            <Text fontSize={'2xl'} fontFamily="cursive" textAlign={'left'}>
          ...
          <Box width={['100%', '100%', '100%', '50%']} height={'100%'}>
            <Image
              ...
              height={'100%'}
              src={
                'https://images.pexels.com/photos/6347900/pexels-photo-6347900.jpeg?auto=compress&cs=tinysrgb&w=1600'
              }
              objectFit="contain"
            />
          </Box>
      ...
      <Box padding={'8'} bg="blackAlpha.800">
        ...
        >
          <div className="stats-container">
            <div className="counter" data-number="50">
              50+
            </div>
            <Heading>No. of Courses</Heading>
          </div>
          <div className="stats-container">
            <div className="counter" data-number="100">
              100+
            </div>
            <Heading>Hours of Content</Heading>
          </div>
          <div className="stats-container">
            <div className="counter" data-number="10">
              10+
            </div>
      ...
      <div className="price-container">
        <Heading textAlign={'center'} size={'2xl'} marginBottom={'40px'}>
          Start Learning Now
        </Heading>
        <Card />
      </div>
