              ...
              <Tbody>
                {
                  courses.map((item)=>(
                    ...
                    <Row item={item} key={item._id} loading={loading} deleteButtonHandler={deleteButtonHandler} courseDetailsHandler={courseDetailsHandler}  />
                  ))
                }
              </Tbody>
            </Table>
          </TableContainer>
          <CourseModal loading={loading} isOpen={isOpen} onClose={onClose} lectures={lectures} deleteLectureButtonHandler={deleteLectureButtonHandler} addLectureHandler={addLectureHandler} id={courseId} courseTitle={courseTitle} />
        </Box> 
        <Sidebar/>
    </Grid>
  )
    ...
    <Tr>
      ...
      <Td isNumeric>
        <HStack justifyContent={'flex-end'}>
          ...
          <Button color={'purple.600'} isLoading={loading} onClick={()=>deleteButtonHandler(item._id)}> 
            <RiDeleteBin7Fill/>
          </Button>
        </HStack>
      </Td>
