...
const Subscribe = ({user}) => {
  ...
  },[dispatch,error,subscriptionId,user.email,user.name,key,courseError])
  return (
    <Container height={'90vh'} p='16'>
      ...
      <VStack boxShadow={'lg'} alignItems={'stretch'} borderRadius={'lg'} spacing={'0'}>
        <Box bg='yellow.400' p='4' css={{borderRadius:"8px 8px 0 0"}}>
          <Text color={'black'} children={`Pro Pack - Rs. 499.00 Only`}>
        ...
        <Box p='4'>
          ...
          <Button my='8' width={'full'} colorScheme='yellow' isLoading={loading} onClick={subscribeHandler}>Buy Now</Button>
        </Box>
        <Box bg='blackAlpha.600' p='4' css={{borderRadius:"0 0 8px 8px"}}>
          <Heading size={'sm'} textTransform={'uppercase'} color={'white'} >100% Refund at cancellation</Heading>
